...
int8_t Rxlora::receive(uint8_t *data_received, LinkMode mode) {
...
void Rxlora::set_link_frequency(LinkMode mode) {
...
uint8_t Rxlora::transmit(uint8_t *data, uint8_t data_len, LinkMode mode) {
...
void Rxlora::set_lora_settings(LoraBandWidth bw, CodingRate cr, SpreadFactor sf,
...
void Rxlora::set_low_frequency_mode(DeviceOperatingMode mode) {
...
void Rxlora::set_default_configurations() {
	set_low_frequency_mode(DeviceOperatingMode::SLEEP);
