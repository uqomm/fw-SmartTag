...
#define PG_EXTI_IRQn EXTI5_IRQn
#define LP_Pin GPIO_PIN_6
#define LP_GPIO_Port GPIOA
#define MR_Pin GPIO_PIN_7
#define MR_GPIO_Port GPIOA
#define DW3000_RST_RCV_Pin GPIO_PIN_2
#define DW3000_RST_RCV_GPIO_Port GPIOB
#define SPI2_CS_Pin GPIO_PIN_8
#define SPI2_CS_GPIO_Port GPIOD
#define LED_BAT_Pin GPIO_PIN_2
#define LED_BAT_GPIO_Port GPIOD
